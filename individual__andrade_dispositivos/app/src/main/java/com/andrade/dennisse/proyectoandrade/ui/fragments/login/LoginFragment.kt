...
import com.andrade.dennisse.proyectoandrade.data.local.repository.DataBaseRepository
...
//        }
    ...
    private fun initBiometric() {
        ...
        when (checkBiometric) {
            ...
            BiometricManager.BIOMETRIC_ERROR_NONE_ENROLLED -> {
                ...
                Snackbar.make(
                    binding.fingerprint, "Ocurrio un error inesperado en el sensor",
    ...
    private fun initListeners() {
        ...
        binding.btnLogin.setOnClickListener {
            loginFragmentVM.authWhitFireBase(
